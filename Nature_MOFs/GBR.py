...
for k in range(len(Target)):
    ...
    R2 = []
    MAPE = []
    GBR=GradientBoostingRegressor(loss='ls',learning_rate=0.1,n_estimators=300,subsample=1.0,criterion='friedman_mse',min_samples_split=2,
    ...
    os.chdir('F:/MOFS_Extra_Data/ML_Graph/GBR_Graph')
